...
print("pinging...\n==============")
ping_response = make_request('GET', 'http://localhost:20000/ping')
print(ping_response)
...
print("登录中...\n==============")
login_response = make_request('POST', 'http://localhost:20000/login', data={
...
teaminfo_response = make_request(
    'GET', f'http://localhost:20000/auth/team/{team_id[0]}',
    headers={'Authorization': f'Bearer {token}'},)
print('获取队伍信息', teaminfo_response)

print("提交...\n==============")
submit_response = make_request('POST', 'http://localhost:20000/auth/submit',
                               headers={'Authorization': f'Bearer {token}'},
...
print("刷新token...\n==============")
refresh_response = make_request('POST', 'http://localhost:20000/auth/refresh',
                                headers={'Authorization': f'Bearer {token}'},
                                data={'team_id': team_id[0]})
