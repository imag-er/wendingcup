...
type kJudgeClient struct {
	*kClient
}

func (p *kJudgeClient) Judge(ctx context.Context, Req *judge.JudgeRequest, callOptions ...callopt.Option) (r *judge.JudgeResponse, err error) {
